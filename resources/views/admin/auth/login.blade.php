...
<head>
    ...
    <title>Masuk Admin — Pivot Cafe</title>
    ...
    <style>
        *, *::before, *::after { 
        ...
        .tombol-masuk .btn-text {
            display: inline-flex;
            align-items: center;
            gap: 8px;
        }

        .tombol-masuk:disabled .btn-text i {
            display: none;
        }
...
<body>
    ...
    <div class="wadah-utama">
        ...
        <section class="sisi-kiri">
            ...
            <div class="kutipan-visual">
                ...
                <h1>Temukan Rasa dalam Setiap Cangkir</h1>
                <p>Kelola kedai dengan mudah, pantau performa, dan wujudkan pengalaman terbaik untuk setiap pelanggan.</p>
            </div>
            <div class="kaki-kiri">
        ...
        <section class="sisi-kanan">
            <div class="kartu-form">
                <div class="header-form">
                    ...
                    <h2>Masuk Admin</h2>
                    <p>Kelola operasional, menu, dan laporan kedai</p>
                </div>

                <!-- Form Login -->
                <!-- PERBAIKAN: action diubah menjadi 'admin.login.submit' sesuai route di web.php -->
                <form method="POST" action="{{ route('admin.login.submit') }}" id="formLogin" novalidate>
                    @csrf
                    ...
                    <div class="grup-form" id="passwordGroup">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                            ...
                            <a href="{{ route('admin.password.request') }}" class="tautan-lupa">
                    ...
                    <!-- Submit Button -->
                    <button type="submit" class="tombol-masuk" id="btnMasuk">
                        <span class="btn-text" id="teksTombol">
                ...
                <div class="teks-bantuan">
                    ...
                    Ada kendala teknis? Hubungi tim Dukungan IT.
                </div>
            </div>
        </section>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if ($errors->any())
                showToast('Gagal Masuk', 'Email atau kata sandi yang Anda masukkan salah.', 'error');
            @endif
            ...
            const tombolIntip = document.getElementById('btnIntipSandi');
            const ikonMata = document.getElementById('ikonMata');

            tombolIntip.addEventListener('click', function(e) {
                e.preventDefault();
            ...
            passwordInput.addEventListener('blur', function() {
                ...
                if (!password) {
                    ...
                    showPasswordError('Kata sandi harus terdiri dari minimal 6 karakter');
                } else {
                    hidePasswordError();
                }
            });
            ...
            passwordInput.addEventListener('input', function() {
                ...
                if (!password) {
                    ...
                    showPasswordError('Minimal 6 karakter');
                } else {
                    hidePasswordError();
                }
            });
            ...
            passwordInput.addEventListener('focus', function() {
                if (this.classList.contains('error')) hidePasswordError();
            });
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (!password || password.length < 6) {
                    showPasswordError(!password ? 'Kata sandi wajib diisi' : 'Minimal 6 karakter');
                    isValid = false;
                } else {
                    hidePasswordError();
                }
                ...
                if (!isValid) {
                    ...
                    if (firstError) {
                        firstError.closest('.grup-form').scrollIntoView({ behavior: 'smooth', block: 'center' });
                    }
                    return;
                }
                ...
                const iconArrow = teksTombol.querySelector('.fa-arrow-right');

                btn.disabled = true;
                teksTombol.innerHTML = 'Memproses...';
